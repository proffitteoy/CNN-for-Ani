...
5. 最终阶段改用 93,904 参数 Position-DS、来源均衡 481 张留出和分来源报告。三成员集成达到 98.80% CharAcc、96.05% ExactAcc 和 0.0478 HammingError；随后按 eval 选出的更新数在全部 3,203 张样本上完成生产重训。
...
- `multi-source holdout`：最终发布依据，但其中 218 张曾参与早期方案选择，不是完全盲测。
